                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :nav="false" :dots="false" >
                                    <div class="pt"  :class="thumbs[0] == image_default ? 'active' : '' " @click="changeImage(thumbs[0])">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" :class="thumbs[1] == image_default ? 'active' : '' "  @click="changeImage(thumbs[1])">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" :class="thumbs[2] == image_default ? 'active' : '' "  @click="changeImage(thumbs[2])">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" :class="thumbs[3] == image_default ? 'active' : '' "  @click="changeImage(thumbs[3])">
...
import HeaderNaima from '@/components/HeaderNaima.vue';
import FooterNaima from '@/components/FooterNaima.vue';
